    ...
    <div className="card">
      <div className="rating-container">
        ...
        <div className="rating">
          <form className="rating-form" name="feedback" method="post" data-netlify="true" data-netlify-honeypot="bot-field">
            <input type="hidden" name="form-name" value="feedback" />
            <label htmlFor="happy">
              <input type="radio" name="rating" className="happy" id="happy" defaultValue="happy" />
            ...
            <label htmlFor="sad">
              <input type="radio" name="rating" className="sad" id="sad" defaultValue="sad" />
